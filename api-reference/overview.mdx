---
title: "DIAN REST API — Endpoints, Base URL, and Error Codes"
sidebarTitle: "Overview"
description: "Base URL, available endpoints, response format conventions, and error codes for the DIAN REST API electronic invoicing service for Colombia."
---
