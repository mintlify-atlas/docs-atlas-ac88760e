...
description: "Reference for PedidoLocalResponse — the Pydantic model returned after a successful DIAN invoice submission, including track_id, CUFE, and status fields."
---
